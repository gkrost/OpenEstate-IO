    ...
    extends JAXBElement<Anlageobjekt.Type>
{
    ...
    protected static final QName NAME = new QName("http://www.immobilienscout24.de/immobilientransfer", "Anlageobjekt");

    public Anlageobjekt(Anlageobjekt.Type value) {
        super(NAME, ((Class<Anlageobjekt.Type> ) Anlageobjekt.Type.class), null, value);
    }

    public Anlageobjekt() {
        super(NAME, ((Class<Anlageobjekt.Type> ) Anlageobjekt.Type.class), null, null);
    }
