    ...
    extends JAXBElement<HausKauf.Type>
{
    ...
    protected static final QName NAME = new QName("http://www.immobilienscout24.de/immobilientransfer", "HausKauf");

    public HausKauf(HausKauf.Type value) {
        super(NAME, ((Class<HausKauf.Type> ) HausKauf.Type.class), null, value);
    }

    public HausKauf() {
        super(NAME, ((Class<HausKauf.Type> ) HausKauf.Type.class), null, null);
    }
