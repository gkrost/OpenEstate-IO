    ...
    extends JAXBElement<Gastronomie.Type>
{
    ...
    protected static final QName NAME = new QName("http://www.immobilienscout24.de/immobilientransfer", "Gastronomie");

    public Gastronomie(Gastronomie.Type value) {
        super(NAME, ((Class<Gastronomie.Type> ) Gastronomie.Type.class), null, value);
    }

    public Gastronomie() {
        super(NAME, ((Class<Gastronomie.Type> ) Gastronomie.Type.class), null, null);
    }
