    ...
    extends JAXBElement<GrundstueckWohnenMiete.Type>
{
    ...
    protected static final QName NAME = new QName("http://www.immobilienscout24.de/immobilientransfer", "GrundstueckWohnenMiete");

    public GrundstueckWohnenMiete(GrundstueckWohnenMiete.Type value) {
        super(NAME, ((Class<GrundstueckWohnenMiete.Type> ) GrundstueckWohnenMiete.Type.class), null, value);
    }

    public GrundstueckWohnenMiete() {
        super(NAME, ((Class<GrundstueckWohnenMiete.Type> ) GrundstueckWohnenMiete.Type.class), null, null);
    }
