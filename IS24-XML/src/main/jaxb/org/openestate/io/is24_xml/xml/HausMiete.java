    ...
    extends JAXBElement<HausMiete.Type>
{
    ...
    protected static final QName NAME = new QName("http://www.immobilienscout24.de/immobilientransfer", "HausMiete");

    public HausMiete(HausMiete.Type value) {
        super(NAME, ((Class<HausMiete.Type> ) HausMiete.Type.class), null, value);
    }

    public HausMiete() {
        super(NAME, ((Class<HausMiete.Type> ) HausMiete.Type.class), null, null);
    }
