...
public class WohnungKauf
    extends JAXBElement<WohnungKauf.Type>
{

    protected static final QName NAME = new QName("http://www.immobilienscout24.de/immobilientransfer", "WohnungKauf");

    public WohnungKauf(WohnungKauf.Type value) {
        super(NAME, ((Class<WohnungKauf.Type> ) WohnungKauf.Type.class), null, value);
    }

    public WohnungKauf() {
        super(NAME, ((Class<WohnungKauf.Type> ) WohnungKauf.Type.class), null, null);
    }
