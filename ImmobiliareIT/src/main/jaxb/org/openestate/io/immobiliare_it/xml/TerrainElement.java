...
/**
 * <p>Java class for terrainElement complex type</p>.
 * 
...
public class TerrainElement implements Serializable, Cloneable, CopyTo, Equals, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            strategy.appendField(locator, this, "terrain", buffer, theTerrain, (this.terrain!= null));
        }
        return buffer;
    }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TerrainElement) {
            ...
            {
                Boolean terrainShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.terrain!= null));
                if (terrainShouldBeCopiedAndSet == Boolean.TRUE) {
                    TerrainType sourceTerrain;
                    sourceTerrain = this.getTerrain();
                    TerrainType copyTerrain = ((TerrainType) strategy.copy(LocatorUtils.property(locator, "terrain", sourceTerrain), sourceTerrain, (this.terrain!= null)));
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final TerrainElement that = ((TerrainElement) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "terrain", lhsTerrain), LocatorUtils.property(thatLocator, "terrain", rhsTerrain), lhsTerrain, rhsTerrain, (this.terrain!= null), (that.terrain!= null))) {
                return false;
            }
        }
        return true;
