...
/**
 * <p>Java class for buildingMap complex type</p>.
 * 
...
@XmlType(name = "buildingMap")
@Generated(value = "com.sun.tools.xjc.Driver", comments = "JAXB RI v4.0.9", date = "2026-08-26T20:17:08+02:00")
public class BuildingMap implements Serializable, Cloneable, CopyTo, Equals, ToString
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof BuildingMap) {
            final BuildingMap copy = ((BuildingMap) draftCopy);
            {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final BuildingMap that = ((BuildingMap) object);
        {
            Breadcrumb lhsMap;
            lhsMap = this.getMap();
            Breadcrumb rhsMap;
