...
public class Sonstigekostennetto implements Serializable, Cloneable, CopyTo, Equals, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "sonstigekostenust", buffer, theSonstigekostenust, (this.sonstigekostenust!= null));
        }
        return buffer;
    }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Sonstigekostennetto) {
            ...
            {
                Boolean sonstigekostenustShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.sonstigekostenust!= null));
                if (sonstigekostenustShouldBeCopiedAndSet == Boolean.TRUE) {
                    BigDecimal sourceSonstigekostenust;
                    sourceSonstigekostenust = this.getSonstigekostenust();
                    BigDecimal copySonstigekostenust = ((BigDecimal) strategy.copy(LocatorUtils.property(locator, "sonstigekostenust", sourceSonstigekostenust), sourceSonstigekostenust, (this.sonstigekostenust!= null)));
                    copy.setSonstigekostenust(copySonstigekostenust);
                } else {
                    if (sonstigekostenustShouldBeCopiedAndSet == Boolean.FALSE) {
