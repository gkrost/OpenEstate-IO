...
public class Immobilie implements Serializable, Cloneable, CopyTo, Equals, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "bieterverfahren", buffer, theBieterverfahren, (this.bieterverfahren!= null));
        }
        {
            Versteigerung theVersteigerung;
            theVersteigerung = this.getVersteigerung();
            strategy.appendField(locator, this, "versteigerung", buffer, theVersteigerung, (this.versteigerung!= null));
        }
        {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "bewertung", buffer, theBewertung, (this.bewertung!= null));
        }
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Immobilie) {
            ...
            {
                Boolean bieterverfahrenShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.bieterverfahren!= null));
                if (bieterverfahrenShouldBeCopiedAndSet == Boolean.TRUE) {
                    Bieterverfahren sourceBieterverfahren;
                    sourceBieterverfahren = this.getBieterverfahren();
                    Bieterverfahren copyBieterverfahren = ((Bieterverfahren) strategy.copy(LocatorUtils.property(locator, "bieterverfahren", sourceBieterverfahren), sourceBieterverfahren, (this.bieterverfahren!= null)));
                    copy.setBieterverfahren(copyBieterverfahren);
                } else {
                    if (bieterverfahrenShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.bieterverfahren = null;
                    }
                }
            }
            {
                Boolean versteigerungShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.versteigerung!= null));
                if (versteigerungShouldBeCopiedAndSet == Boolean.TRUE) {
                    Versteigerung sourceVersteigerung;
                    sourceVersteigerung = this.getVersteigerung();
                    Versteigerung copyVersteigerung = ((Versteigerung) strategy.copy(LocatorUtils.property(locator, "versteigerung", sourceVersteigerung), sourceVersteigerung, (this.versteigerung!= null)));
                    copy.setVersteigerung(copyVersteigerung);
                } else {
                    if (versteigerungShouldBeCopiedAndSet == Boolean.FALSE) {
            ...
            {
                Boolean bewertungShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.bewertung!= null));
                if (bewertungShouldBeCopiedAndSet == Boolean.TRUE) {
                    Bewertung sourceBewertung;
                    sourceBewertung = this.getBewertung();
                    Bewertung copyBewertung = ((Bewertung) strategy.copy(LocatorUtils.property(locator, "bewertung", sourceBewertung), sourceBewertung, (this.bewertung!= null)));
                    copy.setBewertung(copyBewertung);
                } else {
                    if (bewertungShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.bewertung = null;
                    }
                }
            }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "bieterverfahren", lhsBieterverfahren), LocatorUtils.property(thatLocator, "bieterverfahren", rhsBieterverfahren), lhsBieterverfahren, rhsBieterverfahren, (this.bieterverfahren!= null), (that.bieterverfahren!= null))) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "versteigerung", lhsVersteigerung), LocatorUtils.property(thatLocator, "versteigerung", rhsVersteigerung), lhsVersteigerung, rhsVersteigerung, (this.versteigerung!= null), (that.versteigerung!= null))) {
                return false;
            }
        }
        {
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "bewertung", lhsBewertung), LocatorUtils.property(thatLocator, "bewertung", rhsBewertung), lhsBewertung, rhsBewertung, (this.bewertung!= null), (that.bewertung!= null))) {
                return false;
            }
        }
        {
