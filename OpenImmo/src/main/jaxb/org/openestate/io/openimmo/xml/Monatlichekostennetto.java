...
public class Monatlichekostennetto implements Serializable, Cloneable, CopyTo, Equals, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "monatlichekostenust", buffer, theMonatlichekostenust, (this.monatlichekostenust!= null));
        }
        return buffer;
    }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Monatlichekostennetto) {
            ...
            {
                Boolean monatlichekostenustShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.monatlichekostenust!= null));
                if (monatlichekostenustShouldBeCopiedAndSet == Boolean.TRUE) {
                    BigDecimal sourceMonatlichekostenust;
                    sourceMonatlichekostenust = this.getMonatlichekostenust();
                    BigDecimal copyMonatlichekostenust = ((BigDecimal) strategy.copy(LocatorUtils.property(locator, "monatlichekostenust", sourceMonatlichekostenust), sourceMonatlichekostenust, (this.monatlichekostenust!= null)));
                    copy.setMonatlichekostenust(copyMonatlichekostenust);
                } else {
                    if (monatlichekostenustShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "monatlichekostenust", lhsMonatlichekostenust), LocatorUtils.property(thatLocator, "monatlichekostenust", rhsMonatlichekostenust), lhsMonatlichekostenust, rhsMonatlichekostenust, (this.monatlichekostenust!= null), (that.monatlichekostenust!= null))) {
                return false;
            }
        }
        return true;
