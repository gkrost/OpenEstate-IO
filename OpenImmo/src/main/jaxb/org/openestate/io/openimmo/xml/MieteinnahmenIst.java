...
public class MieteinnahmenIst implements Serializable, Cloneable, CopyTo, Equals, ToString
{
        ...
        if (draftCopy instanceof MieteinnahmenIst) {
            ...
            }
            {
                ...
                if (periodeShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    MieteinnahmenIst.Periode copyPeriode = ((MieteinnahmenIst.Periode) strategy.copy(LocatorUtils.property(locator, "periode", sourcePeriode), sourcePeriode, (this.periode!= null)));
