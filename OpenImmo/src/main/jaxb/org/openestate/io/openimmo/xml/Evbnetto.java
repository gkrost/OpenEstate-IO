...
public class Evbnetto implements Serializable, Cloneable, CopyTo, Equals, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "evbust", buffer, theEvbust, (this.evbust!= null));
        }
        return buffer;
    }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Evbnetto) {
            ...
            {
                Boolean evbustShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.evbust!= null));
                if (evbustShouldBeCopiedAndSet == Boolean.TRUE) {
                    BigDecimal sourceEvbust;
                    sourceEvbust = this.getEvbust();
                    BigDecimal copyEvbust = ((BigDecimal) strategy.copy(LocatorUtils.property(locator, "evbust", sourceEvbust), sourceEvbust, (this.evbust!= null)));
                    copy.setEvbust(copyEvbust);
                } else {
                    if (evbustShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.evbust = null;
                    }
                }
            }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "evbust", lhsEvbust), LocatorUtils.property(thatLocator, "evbust", rhsEvbust), lhsEvbust, rhsEvbust, (this.evbust!= null), (that.evbust!= null))) {
                return false;
            }
        }
        return true;
