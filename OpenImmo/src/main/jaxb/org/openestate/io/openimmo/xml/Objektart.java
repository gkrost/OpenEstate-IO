...
public class Objektart implements Serializable, Cloneable, CopyTo, Equals, ToString
{
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the parken property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the objektartZusatz property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            List<Parken> theParken;
            theParken = (((this.parken!= null)&&(!this.parken.isEmpty()))?this.getParken():null);
            strategy.appendField(locator, this, "parken", buffer, theParken, ((this.parken!= null)&&(!this.parken.isEmpty())));
        }
        {
        ...
        {
            List<String> theObjektartZusatz;
            theObjektartZusatz = (((this.objektartZusatz!= null)&&(!this.objektartZusatz.isEmpty()))?this.getObjektartZusatz():null);
            strategy.appendField(locator, this, "objektartZusatz", buffer, theObjektartZusatz, ((this.objektartZusatz!= null)&&(!this.objektartZusatz.isEmpty())));
        }
        return buffer;
    }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Objektart) {
            ...
            {
                Boolean parkenShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, ((this.parken!= null)&&(!this.parken.isEmpty())));
                if (parkenShouldBeCopiedAndSet == Boolean.TRUE) {
                    List<Parken> sourceParken;
                    sourceParken = (((this.parken!= null)&&(!this.parken.isEmpty()))?this.getParken():null);
                    @SuppressWarnings("unchecked")
                    List<Parken> copyParken = ((List<Parken> ) strategy.copy(LocatorUtils.property(locator, "parken", sourceParken), sourceParken, ((this.parken!= null)&&(!this.parken.isEmpty()))));
                    copy.parken = null;
                    if (copyParken!= null) {
                        List<Parken> uniqueParkenl = copy.getParken();
                        uniqueParkenl.addAll(copyParken);
                    }
                } else {
                    if (parkenShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.parken = null;
                    }
                }
            }
            ...
            {
                Boolean objektartZusatzShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, ((this.objektartZusatz!= null)&&(!this.objektartZusatz.isEmpty())));
                if (objektartZusatzShouldBeCopiedAndSet == Boolean.TRUE) {
                    List<String> sourceObjektartZusatz;
                    sourceObjektartZusatz = (((this.objektartZusatz!= null)&&(!this.objektartZusatz.isEmpty()))?this.getObjektartZusatz():null);
                    @SuppressWarnings("unchecked")
                    List<String> copyObjektartZusatz = ((List<String> ) strategy.copy(LocatorUtils.property(locator, "objektartZusatz", sourceObjektartZusatz), sourceObjektartZusatz, ((this.objektartZusatz!= null)&&(!this.objektartZusatz.isEmpty()))));
                    copy.objektartZusatz = null;
                    if (copyObjektartZusatz!= null) {
                        List<String> uniqueObjektartZusatzl = copy.getObjektartZusatz();
                        uniqueObjektartZusatzl.addAll(copyObjektartZusatz);
                    }
                } else {
                    if (objektartZusatzShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.objektartZusatz = null;
                    }
                }
            }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            List<Parken> lhsParken;
            lhsParken = (((this.parken!= null)&&(!this.parken.isEmpty()))?this.getParken():null);
            List<Parken> rhsParken;
            rhsParken = (((that.parken!= null)&&(!that.parken.isEmpty()))?that.getParken():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "parken", lhsParken), LocatorUtils.property(thatLocator, "parken", rhsParken), lhsParken, rhsParken, ((this.parken!= null)&&(!this.parken.isEmpty())), ((that.parken!= null)&&(!that.parken.isEmpty())))) {
                return false;
            }
        }
        {
        ...
        {
            List<String> lhsObjektartZusatz;
            lhsObjektartZusatz = (((this.objektartZusatz!= null)&&(!this.objektartZusatz.isEmpty()))?this.getObjektartZusatz():null);
            List<String> rhsObjektartZusatz;
            rhsObjektartZusatz = (((that.objektartZusatz!= null)&&(!that.objektartZusatz.isEmpty()))?that.getObjektartZusatz():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "objektartZusatz", lhsObjektartZusatz), LocatorUtils.property(thatLocator, "objektartZusatz", rhsObjektartZusatz), lhsObjektartZusatz, rhsObjektartZusatz, ((this.objektartZusatz!= null)&&(!this.objektartZusatz.isEmpty())), ((that.objektartZusatz!= null)&&(!that.objektartZusatz.isEmpty())))) {
                return false;
            }
        }
        return true;
